...
class Calendar {
	...
	public function __construct()
	{
		...
		$this->naviHref = htmlentities($uri_parts[0]);
	}
	/********************* PROPERTY ********************/
	private $dayLabels = array("Lun", "Mar", "Mié", "Jue", "Vie", "Sáb", "Dom");
	...
	private function _createNavi()
	{
		...
		$title = $month . ' ' . date('Y', strtotime($this->currentYear . '-' . $this->currentMonth . '-1'));
		return '<div class="calendar_header">' . "\r\n" . '<a class="calendar_prev" href="' . $this->naviHref . '?month=' . sprintf('%02d', $preMonth) . '&amp;year=' . $preYear.'">Anterior</a>' . "\r\n" . '<span class="calendar_title">' . $title . '</span>' . "\r\n" . '<a class="calendar_next" href="' . $this->naviHref . '?month=' . sprintf("%02d", $nextMonth) . '&amp;year=' . $nextYear . '">Siguiente</a>' . "\r\n"  . '</div>';
	}
	/**
