...
<div class="content-wrapper">
  <div id="cabecera">
    ...
    <span class="pull-right">
      ...
      <?php if($tipo_bread == "Deposito"):?>
        <a href="<?= base_url('custodia_listado')?>">Custodia</a> /
      <?php else:?>
        ...
        <div class="box box-primary">
          ...
          <form action="<?= base_url($guardar)?>" method="POST" enctype="multipart/form-data" name="myForm" data-toggle="validator">
            ...
            <div class="box-footer">
              ...
              <a href="<?=base_url("{$cargar}/{$id_orden}?ref={$this->input->get('ref')}&searchText={$this->input->get('searchText')}")?>" class="btn btn-labeled btn-success" <?= ($cant_archivos > 0) ? "" : "disabled" ?>><span class="btn-label"><i class="fa fa-upload"></i></span>Cargar Archivos</a>
            </div>
          </form>
        </div><!-- /.box -->
      </div>
                ...
                <div class="">
                  ...
                  <td>
                    <form action="<?=base_url($descargar)?>" method="post">
                      ...
                      <a id="eliminar_archivo" href="<?=base_url("{$eliminar}/{$archivo->id}?ref={$this->input->get('ref')}&searchText={$this->input->get('searchText')}&orden={$id_orden}")?>">Eliminar archivo</a>
                    </form>
                  </td>
                </div>
              </li>
