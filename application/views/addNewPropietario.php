        ...
        <div class="row bg-title" style="position: relative; bottom: 15px; ">
            ...
            <div class="text-right">
                <ol class="breadcrumb" style="background-color: white">
                    ...
                    <li class="active">Agregar nuevo propietario</li>
                </ol>
            </div>
        </div>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Detalles del Propietario</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addPropietario" action="<?php echo base_url() ?>addNewPropietario2" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
