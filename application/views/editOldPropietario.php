...
if(!empty($propietarioInfo))
{
    foreach ($propietarioInfo as $ef)
    {
        $propietarioId              = $ef->id;
        $descrip                    = $ef->descrip;
        $activo                     = $ef->activo;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Propietarios
        <small>Modificar Propietario</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                 	...
                 	<div class="col-xs-12">
                         <div class="text-right"  >
                              <ol class="breadcrumb" style="background-color: transparent">
                                ...
                                <li><a href="<?=base_url('propietariosListing')?>">Propietarios</a></li>
                                <li class="active">Modificar propietario</li>
                              </ol>          
                         </div>
                    </div>
                </div>
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Detalles Propietario</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" action="<?php echo base_url() ?>editPropietario" method="post" id="editPropietario" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6"> 
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $propietarioId; ?>" name="propietarioId" />
                                    </div>                               
                                </div>
                                <div class="col-md-6">
                                    <div class="col-md-6">
