<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Orden Instalación 
        <small>Agregar / Editar orden de instalación</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                 	...
                 	<div class="col-xs-12">
                         <div class="text-right"  >
                              <ol class="breadcrumb" style="background-color: transparent">
                                ...
                                <li><a href="javascript:history.go(-1)">Ordenes de Instalación</a></li>
                                <li class="active">Agregar orden de Instalación</li>
                              </ol>          
                         </div>
                     </div>
                </div>
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Crear Orden Instalación</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addInsta" action="<?php echo base_url() ?>addNewInstalacion" method="post" role="form">
    ...
    $("#idproyecto").change(function () {
        ...
        .done(function(data) {
            ...
            result.forEach(function(equipo) {
                ...
                if (((equipo['evento_actual'] == 10 && equipo['estado'] == 5) || (equipo['evento_actual'] == 10 && equipo['estado'] == 1 )) && (equipo['tipo'] == 2402 || equipo['tipo'] == 2 || equipo['tipo'] == 6 || equipo['tipo'] == 2401 || equipo['tipo'] == 3 || equipo['tipo'] == 7 || equipo['tipo'] == 400)) {
