		...
		<section class="content-header">
			<div class="row bg-title" style="position: relative; bottom: 15px; ">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h4 class="page-title">Equipos Moviles</h4>
					</div>
					<div class="text-right">
							<ol class="breadcrumb" style="background-color: white">
									<li><a href="<?php echo base_url(); ?>" class="fa fa-home"> Inicio</a></li>
									<li class="active">Equipos Moviles</li>
							</ol>
					</div>
			</div>
		</section>
			...
			<div class="row">
		          ...
		          <div class="box box-primary">
			            <div class="box-header with-border">
			              <h3 class="box-title">Ubicación flota de <b>Vehículos</b></h3>
			            </div>
		            <!-- /.box-header -->
		          ...
		          <div class="box box-primary">
			            <div class="box-header with-border">
			              <h3 class="box-title">Lista de <b>Vehículos</b></h3>
			            </div>
		            <!-- /.box-header -->
		            	<div class="box-body no-padding">
										<div class="col-md-12">
											<div class="form-group">
													...
													<select id="vehiculos" name="vehiculos" class="form-control selectpicker" multiple data-live-search="true" title="Seleccione dominio ..." data-size="10" data-max-options="1" required>
														<optgroup id="opt_proyecto" label="Todos Proyectos" >
															<option value="TODOS">TODOS</option>
														</optgroup>
														<?php foreach ($proyectos as $proyecto): ?>
															<optgroup id="opt_proyecto" label="<?= $proyecto->descrip?>">
																<?php foreach ($vehiculos as $vehiculo):?>
																	<?php if ($proyecto->descrip == $vehiculo->proyecto): ?>
																		<option value="<?=$vehiculo->dominio?>"><?=$vehiculo->dominio." - ".$vehiculo->serie?> </option>
																		<?php endif; ?>
																<?php endforeach; ?>
														</optgroup>
													<?php endforeach; ?>
