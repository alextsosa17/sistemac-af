    ...
    <div class="row">
      <div class="col-xs-4">
        ...
        <div class="box box-primary">
          <div class="box-header">
            <h1 class="box-title">
							<?= "Total de desaprobadas <span class='text-primary'>$total_imagenes</span>"?>
            </h1>
          </div><!-- /.box -->
        </div>
    	</div>
											 ...
											 <div class="modal-dialog">
													 <div class="modal-content">
															 ...
															 <div class="modal-body">
																 ...
																 <p><strong>Total de desaprobadas:</strong> Cantidad de desaprobadas del equipo. No confundir con el total de imágenes del protocolo.</p>
														...
														<div class="swiper-slide">
															<div class="row">
																<div class="col-lg-6">
																	...
																	<!-- <img src="http://edicion-metro.cecaitra.com/modulos/ver-foto-tam-araujo.php?p=<?=$id_protocolo?>&f=<?=$fotos[$imagen_a_empezar]['imagen1']?>&c=50" width="50%" height="50%"> -->
																</div>
												           ...
												           <div class="box-body table-responsive no-padding">
												               <table class="table table-bordered">
												                  <tbody>
																						<tr>
																							<td colspan="4"><span class="text-danger"><b> <?=$fotos[$imagen_a_empezar]['codigo_error']?></b></span>
																							</td>
																						</tr>
																						<tr>
                ...
                <div id="thumbs" class="swiper-container mb60">
                    <div class="swiper-wrapper">
											<?php for ($imagen_a_empezar1; $imagen_a_empezar1 < $imagen_a_terminar; $imagen_a_empezar1++): ?>
												...
												<!-- <img id="image" src="<?php echo base_url(); ?>assets/images/codigos/<?=$fotos[$imagen_a_empezar1]['dominio']?>.jpg" style="border: 1px solid grey"> -->
												</div>
											<?php endfor; ?>
                    </div>
                </div>
