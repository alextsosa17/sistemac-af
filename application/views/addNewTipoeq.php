    ...
    <section class="content-header">
        <div class="row bg-title" style="position: relative; bottom: 15px; ">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Tipos de Equipos</h4> 
            </div>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Detalles del Tipo de Equipo</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" id="addTipoeq" action="<?php echo base_url() ?>addNewTipoequipo" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <p style="text-align: left;"> <input type="checkbox" id="activo" name="activo" id="activo">
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
