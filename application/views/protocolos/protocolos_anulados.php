...
<div class="content-wrapper">
    <div id="cabecera">
  		Protocolos - Protocolos Anulados
  		<span class="pull-right">
  			<a href="<?= base_url(); ?>" class="fa fa-home"> Inicio</a> /
  		  <span class="text-muted">Protocolos Anulados</span>
  		</span>
  	</div>
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <?php endif; ?>
                    ...
                    <div class="box-tools">
                        <form action="<?= base_url("protocolosanuladoListing") ?>" method="GET" id="searchList">
                  ...
                  <div class="box-body table-responsive no-padding">
                    <table class="table table-bordered table-striped table-hover">
                      ...
                      <?php foreach ($protocolosRecords as $key => $record): ?>
                        ...
                        <!-- Fecha de anulado -->
                        <td class="text-center"><?= date('d/m/Y - H:i',strtotime($record->fecha_anulacion));?>
                        </td>

                        <!-- Subida por -->
                        <td class="text-center"><?= $record->anulado_por;?></td>

                        <!-- Motivo -->
                        <td class="text-center"><?=trim(ucfirst(strtolower($record->motivo)));?></td>

                        <!-- Cantidad Archivos -->
                        <td class="text-center"><span class="label label-danger etiqueta13"><?= $record->bajada_archivos;?></span></td>

                        <td>
                          <?php if($INGanulados[0] == 1) { ?>
