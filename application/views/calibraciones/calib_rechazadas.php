...
$CALIBrechazadas = explode(',', $calibracion_rechazadas); //Los permisos para cada boton de Acciones.
          ...
          <div class="box">
            <div class="box-header">
                ...
                <?php if ($total_tabla > 0): ?>
                  <div class="box-tools">
                      <form action="<?= base_url('calibraciones_rechazadas') ?>" method="POST" id="searchList">
                    ...
                    <table class="table table-bordered table-hover">
                      ...
                      <?php foreach ($ordenes as $orden): ?>
                        <tr>
                          ...
                          <td class="text-center"><span class="<?= $orden->label;?>"><?= $orden->descripPrioridad;?></span></td>
                          ...
                          <td>
                            ...
                            <?php if (($CALIBrecahazadas[0] == 1) && ($orden->tipo_orden == 99)): ?>
                            <?php endif; ?>
                          </td>
                        </tr>
                      <?php endforeach; ?>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "calibraciones_rechazadas/" + value);
