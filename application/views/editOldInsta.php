...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ORDEN INSTALACION Management
        <small>Modificar Orden Instalación</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Detalles Orden Instalación</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" action="<?php echo base_url() ?>editInsta" method="post" id="editRepa" role="form">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="instaId" name="instaId" value="<?php echo $instaId ?>" size="10" readonly>
                                    </div>
                                </div>
                        </div>
                        </div><!-- /.box-body -->
